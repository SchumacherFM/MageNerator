...
/**
 * Test case for class Tx_Magenerator_Controller_UserExtensionsController.
 *
 * @version $Id$
 ...
 */
class Tx_Magenerator_Controller_UserExtensionsControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**

 ...
 */
abstract class Tx_Magenerator_ViewHelpers_Auth_AbstractAuthViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractConditionViewHelper {
	...
	/**
	 * @param Tx_Magenerator_Service_Auth $authService
	 */
	public function injectAuthService(Tx_Magenerator_Service_Auth $authService) {
		$this->authService;
	}

	/**
	 * @param Tx_Magenerator_Service_User $userService
	 */
	public function injectUserService(Tx_Magenerator_Service_User $userService) {
	...
	public function initialize() {
		...
		$this->authService = $objectManager->get('Tx_Magenerator_Service_Auth');
		$this->userService = $objectManager->get('Tx_Magenerator_Service_User');
	}
